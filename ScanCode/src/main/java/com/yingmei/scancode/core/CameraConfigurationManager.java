...
final class CameraConfigurationManager {
    ...
    boolean switchFlashlight(Camera camera) {
        Camera.Parameters parameters = camera.getParameters();
        String curMode = parameters.getFlashMode();
        String flashMode = findSettableValue(parameters.getSupportedFlashModes(), Camera.Parameters.FLASH_MODE_TORCH, Camera.Parameters.FLASH_MODE_ON);
        boolean b = true;
        if (curMode.contains(flashMode)) {
