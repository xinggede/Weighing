...
public class CusItemDecoration extends RecyclerView.ItemDecoration {
     ...
     */
    public CusItemDecoration(@ColorInt int color) {
        this(color, 0);
    }

    public CusItemDecoration(@ColorInt int color, int padding) {
        this(color, padding, 1, 1, -1);
    }
     ...
     */
    public CusItemDecoration(@ColorInt int color, int padding, int dividerWidth, int dividerHeight, int... excludeViewType) {
